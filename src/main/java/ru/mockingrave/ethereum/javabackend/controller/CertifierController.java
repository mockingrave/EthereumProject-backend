...
import ru.mockingrave.ethereum.javabackend.service.CertifierService;
...
public class CertifierController {
    ...
    public ResponseEntity<CertificateDto> createCertificate
            (@RequestBody IpfsCertificateDto dto, String walletName, String password) {
        return ResponseEntity.ok()
                .body(cService.createCertificate(dto, walletName, password));
    }
